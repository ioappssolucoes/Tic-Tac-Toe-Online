...
var ClientWebSocket = function () {
    ...
    _createClass(ClientWebSocket, [{
        ...
        value: function send(msg) {
            if (this.isConnected) this.ws.send(msg);
        }
...
var TicTacToe = function (_React$Component) {
    ...
    function TicTacToe(props) {
        ...
        _this.clientWebSocket = new _ClientWebSocket2.default('ws://localhost:8080');
        // Set the listeners
        _this.clientWebSocket.on('open', function () {
            alert('Connection opened');
        });
        _this.clientWebSocket.on('message', function (msg) {
            alert('Received a message from server ' + msg.data);
        });
        _this.clientWebSocket.on('close', function () {
            alert('Connection closed');
        });
        _this.clientWebSocket.on('error', function (err) {
            alert('Error: ');
        });
        return _this;
    }
    ...
    _createClass(TicTacToe, [{
        ...
        value: function render() {
            ...
            // Message Ref Handle
            var messageRefHandle = function messageRefHandle(e) {
                _this2.messageRef = e;
            };
            // Sned Click Handle
            var sendClickHandle = function sendClickHandle() {
                _this2.clientWebSocket.send(JSON.stringify({ data: _this2.messageRef.value }));
                _this2.messageRef.value = '';
            };
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement('input', { ref: function ref(e) {
                        return messageRefHandle(e);
                    }, type: 'text' }),
                _react2.default.createElement(
                    'button',
                    { onClick: function onClick() {
                            return sendClickHandle();
                        } },
                    ' Send '
                )
            );
...
},{"./ClientWebSocket":1,"react":26,"react-dom":23}],3:[function(require,module,exports){
/**
