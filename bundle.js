...
var ClientWebSocket = function () {
    function ClientWebSocket() {
        ...
        var ws = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'ws://localhost:8080';

        _classCallCheck(this, ClientWebSocket);
        ...
        // Listeners
        this.onOpenListener = function () {};
        this.onMessageListener = function (msg) {};
        this.onCloseListener = function () {};
        this.onErrorListener = function (err) {};

        // Set listeners
        this.ws.onopen = function () {
            _this.isConnected = true;
            _this.onOpenListener();
        };
        this.ws.onclose = function () {
            _this.isConnected = false;
            _this.onCloseListener();
        };
        this.ws.onmessage = function (msg) {
            _this.onMessageListener(JSON.parse(msg.data));
        };
        this.ws.onerror = function (err) {
            _this.onErrorListener(err);
        };
    }
    ...
    _createClass(ClientWebSocket, [{
        key: 'on',
        value: function on(event, callback) {
            if (event == 'open') this.onOpenListener = callback;else if (event == 'message') this.onMessageListener = callback;else if (event == 'close') this.onCloseListener = callback;else if (event == 'error') this.onErrorListener = callback;
        }
...
function inputHandleKeyPress(e) {
	if (e.key === 'Enter') this.buttonHandleClick();
}
...
var Login = function (_React$Component) {
	...
	function Login(props) {
		...
		_this.inputHandleChange = inputHandleChange.bind(_this);
		_this.inputHandleKeyPress = inputHandleKeyPress.bind(_this);
		_this.buttonHandleClick = buttonHandleClick.bind(_this);
		return _this;
	}
				...
				_react2.default.createElement(
					...
					_react2.default.createElement('input', {
						onChange: function onChange(e) {
							return _this2.inputHandleChange(e);
						},
						onKeyPress: function onKeyPress(e) {
							return _this2.inputHandleKeyPress(e);
						},
						type: 'text',
						className: '',
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						{ onClick: function onClick() {
								return _this2.buttonHandleClick();
							}, className: '' },
						'Login'
					)
				)
...
},{"prop-types":24,"react":31,"react-dom":28}],3:[function(require,module,exports){
'use strict';
...
var WaitingPlayer = function (_React$Component) {
	_inherits(WaitingPlayer, _React$Component);

	function WaitingPlayer(props) {
		_classCallCheck(this, WaitingPlayer);

		return _possibleConstructorReturn(this, (WaitingPlayer.__proto__ || Object.getPrototypeOf(WaitingPlayer)).call(this, props));
	}

	_createClass(WaitingPlayer, [{
		key: 'render',
		value: function render() {
			return _react2.default.createElement(
				'h1',
...
exports.default = WaitingPlayer;

},{"prop-types":24,"react":31,"react-dom":28}],4:[function(require,module,exports){
'use strict';
...
var _ClientWebSocket = require('./ClientWebSocket');
...
var _WaitingPlayer = require('./WaitingPlayer.js');

var _WaitingPlayer2 = _interopRequireDefault(_WaitingPlayer);
...
function loginClickHandle(nickname) {
    ...
    // Start websocket
    this.clientWebSocket = new _ClientWebSocket2.default('ws://localhost:8080');

    // Set the listeners
    this.clientWebSocket.on('open', function () {
        // Set isConnected true.
        _this.setState({ isConnected: true });
        // Send Login Package.
        _this.clientWebSocket.send({ type: 'login', content: nickname });
    });

    this.clientWebSocket.on('message', function (msg) {
        _this.onServerMessage(msg);
    });

    this.clientWebSocket.on('close', function () {
        // Set isConnected false.
        _this.setState({ isConnected: false });
    });

    this.clientWebSocket.on('error', function (err) {
...
var TicTacToe = function (_React$Component) {
    ...
    function TicTacToe(props) {
        ...
        // Set default state.
        var _this2 = _possibleConstructorReturn(this, (TicTacToe.__proto__ || Object.getPrototypeOf(TicTacToe)).call(this, props));
        // Calls super
        ...
        // Binds
        _this2.onServerMessage = onServerMessage.bind(_this2);
        _this2.loginClickHandle = loginClickHandle.bind(_this2);
        // Binds
        return _this2;
    }
    ...
    _createClass(TicTacToe, [{
        ...
        value: function render() {
            ...
            var getCurrentPage = function getCurrentPage() {
                if (_this3.state.status === 'waiting') {
                    return _react2.default.createElement(_WaitingPlayer2.default, null);
                } else if (_this3.state.status === 'login') {
                    return _react2.default.createElement(_Login2.default, { onClick: function onClick(v) {
                            return _this3.loginClickHandle(v);
                        } });
                }
            };
            return _react2.default.createElement(
...
_reactDom2.default.render(_react2.default.createElement(TicTacToe, null), document.getElementById('root'));

},{"./ClientWebSocket":1,"./Login":2,"./WaitingPlayer.js":3,"react":31,"react-dom":28}],5:[function(require,module,exports){
/**
...
},{"fbjs/lib/ExecutionEnvironment":5,"fbjs/lib/containsNode":8,"fbjs/lib/emptyFunction":9,"fbjs/lib/emptyObject":10,"fbjs/lib/getActiveElement":11,"fbjs/lib/invariant":14,"fbjs/lib/shallowEqual":17,"object-assign":19,"react":31}],28:[function(require,module,exports){
(function (process){
'use strict';
...
},{"_process":20,"fbjs/lib/emptyFunction":9,"fbjs/lib/emptyObject":10,"fbjs/lib/invariant":14,"fbjs/lib/warning":18,"object-assign":19,"prop-types/checkPropTypes":21}],30:[function(require,module,exports){
/** @license React v16.4.1
...
},{"fbjs/lib/emptyFunction":9,"fbjs/lib/emptyObject":10,"fbjs/lib/invariant":14,"object-assign":19}],31:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./cjs/react.development.js":29,"./cjs/react.production.min.js":30,"_process":20}]},{},[4]);
